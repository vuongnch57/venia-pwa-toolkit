...
/**
 * Webpack resolver plugin that swaps a `@magento/<package>/lib/...` import for a
 * local override under `src/overrides/<package>/...` whenever that mirrored file
 * exists. Keep your imports as `@magento/...` and this plugin redirects them.
 *
 * Registered per-package from local-intercept.js. See that file for wiring.
 */
